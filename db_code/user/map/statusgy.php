...
$sql= "SELECT emp.empID, emp.empName, firestation.fsName, emp.dept, emp.Estatus FROM emp inner JOIN firestation ON emp.fsID = firestation.fsID WHERE emp.Estatus='O' AND firestation.areaName='goyang'";
