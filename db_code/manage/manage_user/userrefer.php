...
<body>
  <br><h3>==일반 회원 전체 data==</h3><br>
  <div>
    <div style="white-space:nowrap; overflow:auto;  width:80%; height:300px; margin:0 auto;">
  <?php
...
(DESCRIPTION =
   ...
   $sql= "SELECT u.empID, u.userName, u.userTel, e.dept, u.userID, u.userPW, f.areaName, u.AdminCode FROM emp e, users u, firestation f WHERE e.empID = u.empID AND e.fsID = f.fsID";
   ...
   echo "<TABLE border=1>";
   echo "<TR>";
   echo "<TH>직원 ID</TH><TH>이름</TH><TH>전화번호</TH><TH>부서</TH><TH>ID</TH><TH>PASSWD</TH><TH>관할지역</TH><TH>관리자코드</TH>";
   echo "</TR>";
...
<br>
<h3>==관리자조회==<h3><br>
        <div style="white-space:nowrap; overflow:auto;  width:80%; height:200px; margin:0 auto;">
        <?php
$db ='
 (DESCRIPTION =
        (ADDRESS_LIST =
...
$sql= "SELECT u.empID, u.userName, u.userTel, e.dept, u.userID, u.userPW, f.areaName, u.AdminCode FROM emp e, users u, firestation f WHERE e.empID = u.empID AND e.fsID = f.fsID AND u.AdminCode is not null";
