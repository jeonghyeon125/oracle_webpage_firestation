...
<ul class="navbar__icons"></ul>
 ...
 <body>
   ...
   <h3>==일반회원 추가==</h3>
   <form method="get" name="form" action="usermanac.php">
      직원 ID :&nbsp;<input type="text" placeholder="" name="empID"><br><br>
      이름 :&nbsp;<input type="text" placeholder=" 영어로 입력" name="userName"><br><br>
      전화번호 :&nbsp;<input type="text" placeholder=" - 사용금지" name="userTel"><br><br>
      ID :&nbsp;<input type="text" placeholder="" name="userID"><br><br>
      PASSWD :&nbsp;<input type="text" placeholder="" name="userPW"><br><br>
      관리자 코드 :&nbsp;<input type="text" placeholder="관리자일 경우 입력" name="AdminCode"><br><br>
