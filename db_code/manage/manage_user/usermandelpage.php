...
<ul class="navbar__icons"></ul>
 ...
 <body>
   ...
   <form method="get" name="form" action="usermandelete.php"><br>
    <h3>==일반회원 삭제==</h3><br>회원번호 입력&nbsp;<input type="text" name="empID">
            <input type="submit" value="삭제" onclick="send()"><br><br>
        </form>
        <form method="get" name="form" action="usermanupdate.php">
            <h3>==일반회원 수정==</h3><br>회원번호 입력&nbsp;<input type="text" name="empID">
