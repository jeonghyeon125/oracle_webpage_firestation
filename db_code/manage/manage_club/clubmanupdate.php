...
.inputbox{position: absolute; left: 50%; transform: translate(-50%); text-align: center;}
...
(DESCRIPTION =
   ...
   while(($row = oci_fetch_array($stat, OCI_BOTH)) != false) {
    echo "<FORM METHOD=\"post\"  ACTION=\"clubmanupdateac.php\">\n";
    echo "       동아리 ID :&ensp;&nbsp;<input type=\"text\" name = \"clubID\" VALUE= $row[0] READONLY ><br><br>\n";
    echo "       동아리 이름 :&nbsp;<input type=\"text\" name = \"clubName\" VALUE=$row[1]><br><br>\n";
    echo "           <BR>\n";
