...
(DESCRIPTION =
 ...
 while(($row = oci_fetch_array($stat, OCI_BOTH)) != false) {
  echo "<FORM METHOD=\"post\"  ACTION=\"empmanupdateac.php\">\n";
  echo "       직원 ID :&nbsp;<input type=\"text\" name = \"empID\" VALUE= $row[0] READONLY ><br><br>\n";
  echo "       안전센터 ID :&nbsp;<input type=\"text\" name = \"fsID\" VALUE=$row[1]><br><br>\n";
  echo "       이름 :&nbsp;<input type=\"text\" name = \"empName\" VALUE=$row[2]><br><br>\n";
  echo "       전화번호 :&nbsp;<input type=\"text\" name = \"empTel\" VALUE=$row[3]><br><br>\n";
  echo "       부서 :&nbsp;<input type=\"text\" name = \"dept\" VALUE=$row[4]><br><br>\n";
  echo "       출동현황 :&nbsp;<input type=\"text\" name = \"Estatus\" VALUE=$row[5]><br><br>\n";
  echo "           <BR><BR>\n";
