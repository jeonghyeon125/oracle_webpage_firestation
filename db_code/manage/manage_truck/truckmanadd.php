...
<ul class="navbar__icons"></ul>
 ...
 <body>
   ...
   <h3>==차량 DATA 추가==</h3><br>
   <form method="get" name="form" action="truckmanaddac.php">
       차량 ID :&nbsp;<input type="text" placeholder="111a1111 형식" name="truckID"><br><br>
       안전센터 ID :&nbsp;<input type="text" placeholder="1~10" name="fsID"><br><br>
       제조일 :&nbsp;<input type="text" placeholder="yyyy.mm.dd" name="Made"><br><br>
       관리기간 :&nbsp;<input type="text" placeholder="숫자만 입력" name="Cyear"><br><br>
       출동현황 :&nbsp;<input type="text" placeholder="추가시 'X'로 입력" name="Tstatus"><br><br>
