...
<ul class="navbar__icons"></ul>
 ...
 <body>
   <div class="inputdata"><br>
        <form method="get" name="form" action="emptruckdelete.php">
            <h3>==소방차량 DATA 삭제==</h3>차량번호 입력&nbsp;<input type="text" name="truckID">
            <input type="submit" value="삭제" onclick="send()"><br><br>
        </form>

        <form method="get" name="form" action="truckmanupdate.php">
            <h3>==소방차량 DATA 수정==</h3>차량번호 입력&nbsp;<input type="text" name="truckID">
